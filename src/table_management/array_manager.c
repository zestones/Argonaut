...
void declaration_array_start() {
    insert_declaration_array(context.index_array_name_lexicographic, get_current_nis(), insert_representation(NULL_VALUE));
...
void declaration_array_end(int index_type_lexicographic) {
    ...
    int index_type_of_array_declaration = find_declaration_index(index_type_lexicographic, get_current_nis());
