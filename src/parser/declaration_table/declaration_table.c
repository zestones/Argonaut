...
Declaration construct_declaration(const char* nature, int next, int region, int description, int execution) {
    Declaration new_declaration;

    strcpy(new_declaration.nature, nature);
...
void insert_declaration(const char *nature, int next, int region, int description, int execution) {
...
void print_declaration_table() {
    ...
    for (int i = 0; i < declaration_table_size; i++) {
        char region_str[10], next_str[10], index_str[10], description_str[10], execution_str[10];
        ...
        print_table_row(6, 
                        ...
                        col_width_nature, declaration_table[i].nature,
